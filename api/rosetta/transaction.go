...
// TransactionRequest implements the request schema for /block/transaction, as described
// in https://www.rosetta-api.org/docs/BlockApi.html#request-1.
...
// TransactionResponse implements the successful response schema for /block/transaction, as described
// in https://www.rosetta-api.org/docs/BlockApi.html#200---ok-1.
type TransactionResponse struct {
	Transaction *object.Transaction `json:"transaction"`
}

// Transaction implements the /block/transaction endpoint of the Rosetta Data API, as
// described in https://www.rosetta-api.org/docs/BlockApi.html#blocktransaction.
