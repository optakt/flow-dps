...
func TestAPI_TransactionHandlesErrors(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			checkErr: checkRosettaError(http.StatusBadRequest, fail.ErrorInvalidFormat),
		},
		{
		...
		},
		{
			...
			checkErr: checkRosettaError(http.StatusUnprocessableEntity, fail.ErrorInvalidNetwork),
		},
		{
		...
		},
		{
			...
			checkErr: checkRosettaError(http.StatusInternalServerError, fail.ErrorInternal),
		},
		{
			...
			checkErr: checkRosettaError(http.StatusUnprocessableEntity, fail.ErrorInvalidBlock),
		},
		{
			name: "unknown block",
			request: rosetta.TransactionRequest{
			...
			checkErr: checkRosettaError(http.StatusUnprocessableEntity, fail.ErrorUnknownBlock),
		},
		{
		...
		},
		{
			...
			checkErr: checkRosettaError(http.StatusUnprocessableEntity, fail.ErrorInvalidTransaction),
		},
