...
// BalanceRequest implements the request schema for /account/balance, as described
// in https://www.rosetta-api.org/docs/AccountApi.html#request.
...
// BalanceResponse implements the successful response schema for /account/balance, as described
// in https://www.rosetta-api.org/docs/AccountApi.html#200---ok.
type BalanceResponse struct {
	BlockID  identifier.Block `json:"block_identifier"`
	Balances []object.Amount  `json:"balances"`
}

// Balance implements the /account/balance endpoint of the Rosetta Data API, as
// described in https://www.rosetta-api.org/docs/AccountApi.html#accountbalance.
