...
// BlockRequest implements the request schema for /block, as described
// in https://www.rosetta-api.org/docs/BlockApi.html#request.
type BlockRequest struct {
	NetworkID identifier.Network `json:"network_identifier"`
	BlockID   identifier.Block   `json:"block_identifier"`
}

// BlockResponse implements the response schema for /block, as described
// in https://www.rosetta-api.org/docs/BlockApi.html#200---ok.
type BlockResponse struct {
	Block             *object.Block            `json:"block"`
	OtherTransactions []identifier.Transaction `json:"other_transactions,omitempty"`
}

// Block implements the /block endpoint of the Rosetta Data API, as
// described in https://www.rosetta-api.org/docs/BlockApi.html#block.
