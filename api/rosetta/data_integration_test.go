...
func validateBlock(t *testing.T, height uint64, hash string) validateBlockFunc {
	...
	return func(blockQualifier identifier.Block) {
		if assert.NotNil(t, blockQualifier.Index) {
			assert.Equal(t, height, *blockQualifier.Index)
		}
		assert.Equal(t, hash, blockQualifier.Hash)
	}
}
...
func knownHeader(height uint64) flow.Header {
	...
	case 50:
		return flow.Header{
			...
			ParentVoterSig: []byte{0x98, 0x14, 0xd7, 0xc6, 0x82, 0x79, 0x8d, 0x5f, 0x59, 0x21, 0x20, 0xb9, 0xc3, 0x10, 0xb4, 0xed, 0x48, 0xaf, 0xd1, 0x47, 0xee, 0xb2, 0xd8, 0x55, 0xc9, 0x4f, 0x23, 0xe2, 0x33, 0x28, 0xc0, 0xef, 0xd5, 0x85, 0x6b, 0xab, 0x38, 0x2c, 0xab, 0xcd, 0x1e, 0x68, 0x4, 0xa2, 0x96, 0xc3, 0x1f, 0x72, 0x91, 0x5f, 0xd6, 0x94, 0x9d, 0x29, 0xa8, 0x6c, 0xfc, 0xc1, 0xe, 0x5, 0x2f, 0x2d, 0xf6, 0xa0, 0x75, 0x50, 0x83, 0xb, 0x51, 0xa9, 0x8, 0x81, 0xa1, 0xc0, 0xa2, 0xa2, 0x42, 0x2d, 0xa6, 0x5c, 0xd, 0x60, 0x12, 0x61, 0x74, 0xf1, 0xb8, 0x9e, 0x16, 0x45, 0x25, 0xaa, 0xe8, 0xe4, 0x60, 0x5a},
