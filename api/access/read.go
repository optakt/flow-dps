...
// FIXME: Move to an invoker DPS package along with the rosetta invoker.
func readRegister(index index.Reader, cache Cache, height uint64) delta.GetRegisterFunc {
