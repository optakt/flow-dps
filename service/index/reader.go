...
// database.
func NewReader(consDB *badger.DB, execDB *badger.DB, ledgerDB *badger.DB, lib dps.ReadLibrary) *Reader {
...
func (r *Reader) First() (uint64, error) {
	var height uint64
	err := r.consDB.View(r.lib.RetrieveFirst(&height))
	return height, err
}
...
func (r *Reader) Last() (uint64, error) {
	var height uint64
	err := r.consDB.View(r.lib.RetrieveLast(&height))
	return height, err
}
...
func (r *Reader) HeightForBlock(blockID flow.Identifier) (uint64, error) {
	var height uint64
	err := r.consDB.View(r.lib.LookupHeightForBlock(blockID, &height))
	return height, err
}
...
func (r *Reader) Commit(height uint64) (flow.StateCommitment, error) {
	...
	err := r.consDB.View(r.lib.RetrieveCommit(height, &commit))
	return commit, err
}
...
func (r *Reader) Header(height uint64) (*flow.Header, error) {
	...
	err := r.consDB.View(r.lib.RetrieveHeader(height, &header))
	return &header, err
}
...
func (r *Reader) Collection(collID flow.Identifier) (*flow.LightCollection, error) {
	...
	err := r.consDB.View(r.lib.RetrieveCollection(collID, &collection))
...
func (r *Reader) CollectionsByHeight(height uint64) ([]flow.Identifier, error) {
	...
	err := r.consDB.View(r.lib.LookupCollectionsForHeight(height, &collIDs))
	return collIDs, err
}
...
func (r *Reader) Guarantee(collID flow.Identifier) (*flow.CollectionGuarantee, error) {
	...
	err := r.consDB.View(r.lib.RetrieveGuarantee(collID, &collection))
	return &collection, err
}
...
func (r *Reader) Transaction(txID flow.Identifier) (*flow.TransactionBody, error) {
	...
	err := r.consDB.View(r.lib.RetrieveTransaction(txID, &transaction))
...
func (r *Reader) HeightForTransaction(txID flow.Identifier) (uint64, error) {
	var height uint64
	err := r.consDB.View(r.lib.LookupHeightForTransaction(txID, &height))
	return height, err
}
...
func (r *Reader) TransactionsByHeight(height uint64) ([]flow.Identifier, error) {
	...
	err := r.consDB.View(r.lib.LookupTransactionsForHeight(height, &txIDs))
...
func (r *Reader) Result(txID flow.Identifier) (*flow.TransactionResult, error) {
	...
	err := r.execDB.View(r.lib.RetrieveResult(txID, &result))
	return &result, err
}
...
func (r *Reader) Events(height uint64, types ...flow.EventType) ([]flow.Event, error) {
	...
	err = r.execDB.View(r.lib.RetrieveEvents(height, types, &events))
	return events, err
}
...
func (r *Reader) Seal(sealID flow.Identifier) (*flow.Seal, error) {
	var seal flow.Seal
	err := r.execDB.View(r.lib.RetrieveSeal(sealID, &seal))
	return &seal, err
}
...
func (r *Reader) SealsByHeight(height uint64) ([]flow.Identifier, error) {
	...
	err := r.execDB.View(r.lib.LookupSealsForHeight(height, &sealIDs))
	return sealIDs, err
}
