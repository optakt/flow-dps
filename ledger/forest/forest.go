...
// written value.
func (f *Forest) Update(db *badger.DB, u *ledger.TrieUpdate) (ledger.RootHash, error) {
	...
	newTrie, err := trie.NewTrieWithUpdatedRegisters(db, parentTrie, deduplicatedPaths, deduplicatedPayloads)
	if err != nil {
